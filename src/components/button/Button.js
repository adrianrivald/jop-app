...
export default function Button({
    ...
    return (
        <>
            ...
            {
                isFilter ?
                <button className={`bg-white text-xs shadow flex items-center justify-between text-black font-bold p-2.5 rounded-xl w-full`} {...rest}>
                    ...
                    {
                        filterCount !== 0 && (
                            <div className="ml-3 py-1 px-2 text-white bg-sun rounded-md text-xxs">{filterCount}</div>
                        )
                    }
                </button> : null
