        ...
        <div className="mt-4">
          ...
          <div className="notes">
            ...
            <p className="font-bold">
              Maaf, Dan.. Saya mohon ijin untuk tidak bekerja pada tugas kali ini karena sakit. Kaki kanan saya masih
              belum pulih dari kecelakaan tugas kemarin. Mohon ijin. Terimakasih.
            </p>
          </div>
        </div>
        <div className="mt-11">
