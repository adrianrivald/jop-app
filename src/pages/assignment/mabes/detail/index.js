...
function MabesDetail() {
    ...
    const onCancel = () => {
        ...
        axios.post(`${url}penugasan/batalkan-tugas`, {
            penugasan_id: detailData.id
        }, config).then((res) => {
            setIsSubmitted(true)
                ...
                </div>   
                {
                    ...
                    <>
                        ...
                        <>
                            ...
                            <div className='mt-11'>
                                <Button isText={true} text={"Izinkan dan lakukan pengalihan"} className='w-full rounded-xl text-sm' onClick={onSwitch}/>
                                <Button className='mt-2 w-full rounded-xl text-sm' role='white' isBack isText text='Batalkan Tugas' onClick={onCancel} />
                            </div>
                        </>
                    )
                }
