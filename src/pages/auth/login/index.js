  ...
  return (
    <div className="relative h-screen flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col items-center p-12 w-full">
        {/* username */}
        <input
          className="w-full rounded-lg py-4 px-4 text-xs leading-tight focus:outline-none focus:shadow-outline"
          type="text"
        ...
        <label className="relative block flex justify-between w-full bg-white rounded-lg p-3">
          <input
            className="text-xs leading-tight w-full mr-2 focus:outline-none focus:shadow-outline"
