                            ...
                            return (
                                <div className="detail my-3">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div>
                                            <Button className="text-xs" isText text="Load" onClick={() => navigate(`/logistic/loading/${res?.id}`)}/>
                                        </div>
                                    </div>
                                    {
                                        idx === 0 && (
