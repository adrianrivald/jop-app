      ...
      <div className="container">
        ...
        <div>
          ...
          <div className="flex gap-3 my-1">
            ...
            <p className="w-2/4 font-bold">Ojek - Motor (120 Kg)</p>
          </div>
          <div className="flex gap-3 my-1">
            <p className="w-2/4">Armada</p>
            <p className="w-2/4 font-bold">B 3355 QPR - 01</p>
          </div>
          <div className="flex gap-3 my-1">
            <p className="w-2/4">Alamat / fasilitas tujuan</p>
            <div className="w-2/4 ">
              <p className="font-bold">Gudang Induk</p>
          ...
          <div className="flex gap-3 my-1">
            ...
            <div className="w-2/4 ">
              <p className="font-bold">Aji Kuntara / 02887</p>
              <p className="font-bold">PKWT</p>
            </div>
          </div>
          <div className="flex gap-3 my-1">
            <p className="w-2/4">Pengawal</p>
            <div className="w-2/4 ">
              <p className="font-bold">Sumber Wono / 02887</p>
              <p className="font-bold">PKWT</p>
            </div>
          </div>
