    ...
    <>
      ...
      <div className="container">
        ...
        {weighingDetail?.detail?.map((res, id) => (
          <div
            className={`flex justify-between items-center text-lg my-1 ${
              stored_data.find((val) => val.id === id) ? '' : 'opacity-50'
            }`}
          >
            <p>
            ...
            <p className="font-bold">
              {res.berat_total}
              <span className="font-normal"> kg</span>
            </p>
          </div>
        ))}
        ...
        <div className="history mt-5">
          ...
          <div className={`accordion divide-y divide-cloud`}>
            {weighingDetail?.transaction?.length > 0 ? (
              weighingDetail?.transaction?.map((res, idx) =>
                    ...
                    <div className=" p-3 ">
                      ...
                      <div className="flex justify-center mt-3">
                        <Button
                          ...
                          text="Lihat Detail"
                          onClick={() =>
                            onClickDetail(res?.tapper?.id, res?.id, res?.detail, weighingDetail?.transaction[idx])
                          }
                        />
                      </div>
                    </div>
