...
const WeighingTapper = () =>{
    ...
    const getData = async() => {
        if (transaction_id && transaction_id !== undefined) {
            await axios.get(`${url}penimbangan/detail/transaksi/${transaction_id}`,
            {
    ...
    return (
        <>
            ...
            <div className="p-3 mt-1">
                <label htmlFor="file-upload" className="w-full rounded-xl bg-flora text-white font-bold p-3 block text-center flex justify-center items-center gap-2 cursor-pointer">
